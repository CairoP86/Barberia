    ...
    <main className="bg-black text-white">
      ...
      <header className="fixed top-0 left-0 w-full bg-black bg-opacity-80 backdrop-blur-md z-50 shadow-md">
        <nav className="max-w-6xl mx-auto flex justify-between items-center p-4">
          ...
          <ul className="hidden md:flex gap-6 font-semibold">
            ...
            <li>
              <a href="#reservas" className="hover:text-yellow-400 transition">
                Reservas
              </a>
            </li>
            <li>
              <a href="#testimonios" className="hover:text-yellow-400 transition">
                Testimonios
              </a>
            </li>
            <li>
      ...
      <section className="bg-[#f9f6ef] text-center py-16 px-6 text-black">
        ...
        <p className="max-w-3xl mx-auto mb-4">
          ...
          vivas una experiencia única. Hemos creado un ambiente en donde nuestros
          clientes se pueden relajar, escuchar buena música.
        </p>
