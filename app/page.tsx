...
export default function Home() {
  ...
  const servicios = [
    ...
    },
    {
      nombre: "Corte + Barba",
      precio: "₡8,000",
      descripcion: "Incluye diseño de barba, toalla caliente y productos premium.",
    },
    {
    ...
    },
    {
      nombre: "Solo Barba",
      precio: "₡5,000",
      descripcion: "Rasurado o diseño de barba con espuma, after shave y aceite.",
    },
    {
      nombre: "Solo Cejas",
      precio: "₡3,000",
    ...
    <main className="bg-black text-white">
      ...
      <section className="bg-[#f9f6ef] text-center py-16 px-6 text-black">
        ...
        <p className="max-w-3xl mx-auto mb-4">
          ...
          Hemos creado un ambiente en donde nuestros clientes se pueden relajar, escuchar buena música.
        </p>
        <p className="max-w-3xl mx-auto mb-8">
          Nuestro lema refleja nuestra filosofía de trabajo: ofrecer siempre un servicio de calidad que combine 
          estilo, precisión y comodidad para que cada cliente se sienta especial.
        </p>
        <a
          href="#reservas"
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
          <div className="bg-white text-black rounded-lg shadow-xl p-6 max-w-sm w-full">
            ...
            <p className="mb-6">
              ...
              <span className="text-yellow-600">{servicioSeleccionado.precio}</span>).
              <br />
      ...
      <section id="testimonios" className="bg-gray-100 text-black py-16">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-extrabold mb-6 uppercase">Lo que dicen nuestros clientes</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="border border-yellow-500 rounded-xl p-6 shadow-md bg-white hover:shadow-lg transition">
              <p className="italic text-gray-700 mb-4">“Excelente servicio personalizado, fácil reservar por WhatsApp. Muy preciso y el resultado genial.”</p>
              <h4 className="font-bold">– Andrés Ramírez</h4>
            </div>
            <div className="border border-yellow-500 rounded-xl p-6 shadow-md bg-white hover:shadow-lg transition">
              <p className="italic text-gray-700 mb-4">“Los visito mensualmente y siempre salgo satisfecho. Personal muy amable y conocedor.”</p>
      ...
      <section id="galeria" className="bg-black py-12">
        <h2 className="text-3xl font-extrabold text-center mb-8 uppercase">Galería</h2>

        <div
          className="relative max-w-4xl mx-auto"
          onTouchStart={(e: React.TouchEvent<HTMLDivElement>) => (window as any).touchStartX = e.touches[0].clientX}
      ...
      <a href="https://wa.me/50686084560" target="_blank" className="fixed bottom-6 right-6 bg-green-500 text-white p-4 rounded-full shadow-lg hover:scale-110 transition"><FaWhatsapp size={28} /></a>
    </main>
  );
}
